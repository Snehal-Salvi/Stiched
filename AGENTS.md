...
**Stitched** is a local tailor booking app — customers browse and book nearby tailors for stitching blouses, salwar kameez, lehengas, men's shirts, pants, kurtas, alterations, and more. Tailors manage their shop profile, services, pricing, and incoming orders.
...
**Image uploads** (`src/middleware/upload.js`): Multer + Cloudinary, images stored in the `stitched` folder, max 5MB, resized to max 1200px wide. Used for shop photos.
